...
<head>
  ...
  <meta name="description" content="Somos una compañía dedicada al diseño de interiores, muebles, arquitectura, y productos mobiliarios de gama alta para hogares y proyectos corporativos.">
        ...
        <nav class="header_top">
          <div class="header_top_left">
            <div class="menu_logo_li">
              <h1 class="menu_logo" title="Mazal | Diseño interior y Arquitectura" style="font-size: 0px;">
