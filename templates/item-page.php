...
<section class="migadepan container p-0">

    <div class="direccion-pagina row">
        <ul>
            <li><a href="#">Home</a></li>
  ...
  <div class="swiper-button-next swiper-button-white"></div>
    ...
    <div class="swiper-button-prev swiper-button-white"></div>
            ...
            <div class="col-md-5">
                ...
                <p class="item-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione aut quia omnis! Repudiandae ducimus blanditiis, vero exercitationem velit maxime architecto ipsam cumque rerum odit iste nostrum quod excepturi? Deserunt, quod.</p>
                ...
                <div class="item-features">
                    ...
                    <div class="feature">
                    <span>Material :</span><span>some text</span>
                    </div>
                </div>
                
                <div class="color-item-feature">
                     <div>
                     <span class="fw-6">Color :</span><span>Natural</span>
                     </div>
